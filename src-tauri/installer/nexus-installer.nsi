...
; ─── NEXUS White Theme Customization ──────────────────────────
; White background with dark text for a clean, modern installer look
!define MUI_BGCOLOR "FFFFFF"
!define MUI_TEXTCOLOR "1F2937"
!define MUI_HEADER_TEXT_COLOR "1F2937"
!define MUI_WELCOMEPAGE_TITLE "Welcome to NEXUS"
!define MUI_WELCOMEPAGE_TEXT "NEXUS is a cross-platform, Siri-like floating desktop assistant.$\r$\n$\r$\nClick Next to continue with the installation."
!define MUI_FINISHPAGE_TITLE "Installation Complete"
!define MUI_FINISHPAGE_TEXT "NEXUS has been successfully installed.$\r$\n$\r$\nClick Finish to close this wizard."
!define MUI_FINISHPAGE_LINK "Visit NEXUS"
!define MUI_FINISHPAGE_LINK_LOCATION "https://github.com/Engine-NEXUS/NEXUS-Agent"

; GUI init function — sets white background on installer window
; Uses MUI_PAGE_CUSTOMFUNCTION_GUIINIT so we don't conflict with MUI's own .onGUIInit
!define MUI_PAGE_CUSTOMFUNCTION_GUIINIT SetWhiteBg
!define MUI_UNPAGE_CUSTOMFUNCTION_GUIINIT SetWhiteBgUn

Function SetWhiteBg
  SetCtlColors $HWNDPARENT 1F2937 FFFFFF
FunctionEnd

Function SetWhiteBgUn
  SetCtlColors $HWNDPARENT 1F2937 FFFFFF
FunctionEnd
...
Function RunMainBinary
  nsis_tauri_utils::RunAsUser "$INSTDIR\${MAINBINARYNAME}.exe" "--setup"
FunctionEnd
